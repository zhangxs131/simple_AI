...
def evaluate(model, data_loader, device='cpu',label_list=None):
    model.eval()
...
def main():
    ...
    if not args.do_predict:
        train_dataloader,dev_dataloader=gen_dataloader(args.data_path,tokenizer,batch_size=args.batch_size,label_txt=label_list)
        ...
        # train and eval
        train(model,train_dataloader,dev_dataloader,num_epochs=args.num_epoch,lr=args.lr,device=device,log_steps=args.log_steps,model_save_path=args.model_save_path)
    else:
